...
public class SubscribeCandlestickEvent {
    ...
    subscriptionClient.subscribeCandlestickEvent(symbol, CandlestickInterval.MIN5, (candlestickEvent) -> {
      System.out.println("--------------- Subscribe Candlestick ------------------");
      System.out.println("id: " + candlestickEvent.getData().getId());
      System.out.println("Timestamp: " + new Date(candlestickEvent.getData().getTimestamp()));
...
//        subscriptionClient.requestCandlestickEvent(symbol, 1541865660L, 1541865780L, CandlestickInterval.MIN1, false, (candlestickEvent) -> {
...
//                System.out.println("--------------------------------------------");
//            });
//        }, exp -> System.out.println(exp.getErrType()));
    }
